...
export default function Footer() {
  return (
    <footer id="contact" className="bg-accent text-white">
      ...
      >
        {/* Top section */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10 mb-12 lg:mb-16">
          <div className="max-w-md">
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl tracking-tight mb-4 text-white">
              Let's work together
            </h2>
